...
void setup()
{
  ...
  if (compass.begin()) {
    ...
    compass.setOffset(-190, -95);  //new - needs to be changed for each compass. also need to add offset to angle displayed on screen.
      ...
      while(1){
          ...
          float heading = atan2(norm.YAxis, norm.XAxis);
            heading = -heading;
              ...
              int o = 330; //offset - needs to be changed for each compass
          ...
          float heading = atan2(norm.YAxis, norm.XAxis);
            heading = -heading;
              ...
              int o = 330; //offset - need to change for each compass
              if (headingDegrees < 330) {
                headingDegrees = headingDegrees - o + 360;
              } else {
                 headingDegrees = headingDegrees - o;
